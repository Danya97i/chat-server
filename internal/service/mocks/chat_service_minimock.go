...
//go:generate minimock -i github.com/Danya97i/chat-server/internal/service.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
...
type ChatServiceMock struct {
	...
	funcCreate          func(ctx context.Context, title string, userEmails []string) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, title string, userEmails []string)
...
func (mmCreate *mChatServiceMockCreate) Expect(ctx context.Context, title string, userEmails []string) *mChatServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &ChatServiceMockCreateParams{ctx, title, userEmails}
...
// ExpectTitleParam2 sets up expected param title for ChatService.Create
func (mmCreate *mChatServiceMockCreate) ExpectTitleParam2(title string) *mChatServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
...
// ExpectUserEmailsParam3 sets up expected param userEmails for ChatService.Create
func (mmCreate *mChatServiceMockCreate) ExpectUserEmailsParam3(userEmails []string) *mChatServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.paramPtrs.userEmails = &userEmails

	return mmCreate
}

// Inspect accepts an inspector function that has same arguments as the ChatService.Create
func (mmCreate *mChatServiceMockCreate) Inspect(f func(ctx context.Context, title string, userEmails []string)) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) Set(f func(ctx context.Context, title string, userEmails []string) (i1 int64, err error)) *ChatServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatServiceMockCreate) When(ctx context.Context, title string, userEmails []string) *ChatServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &ChatServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &ChatServiceMockCreateParams{ctx, title, userEmails},
	}
...
func (mmCreate *ChatServiceMock) Create(ctx context.Context, title string, userEmails []string) (i1 int64, err error) {
	mm_atomic.AddUint64(&mmCreate.beforeCreateCounter, 1)
	defer mm_atomic.AddUint64(&mmCreate.afterCreateCounter, 1)

	if mmCreate.inspectFuncCreate != nil {
		mmCreate.inspectFuncCreate(ctx, title, userEmails)
	}

	mm_params := ChatServiceMockCreateParams{ctx, title, userEmails}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockCreateParams{ctx, title, userEmails}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.title != nil && !minimock.Equal(*mm_want_ptrs.title, mm_got.title) {
				mmCreate.t.Errorf("ChatServiceMock.Create got unexpected parameter title, want: %#v, got: %#v%s\n", *mm_want_ptrs.title, mm_got.title, minimock.Diff(*mm_want_ptrs.title, mm_got.title))
			}

			if mm_want_ptrs.userEmails != nil && !minimock.Equal(*mm_want_ptrs.userEmails, mm_got.userEmails) {
				mmCreate.t.Errorf("ChatServiceMock.Create got unexpected parameter userEmails, want: %#v, got: %#v%s\n", *mm_want_ptrs.userEmails, mm_got.userEmails, minimock.Diff(*mm_want_ptrs.userEmails, mm_got.userEmails))
			}
	...
	if mmCreate.funcCreate != nil {
		return mmCreate.funcCreate(ctx, title, userEmails)
	}
	mmCreate.t.Fatalf("Unexpected call to ChatServiceMock.Create. %v %v %v", ctx, title, userEmails)
	return
}
